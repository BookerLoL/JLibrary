 ...
 */
public class CircularArray<E> extends AbstractQueue<E> implements List<E>, Stack<E>, RandomAccess, Cloneable {
	protected static final int DEFAULE_CAPACITY = 10;
	...
	/*
	 * Returns the index based on the stack order
	 * 
	 * From end to front
	 */
	@Override
	public int search(Object o) {
		...
		if (front <= end) { // [front ... pos ... end]
			return count - pos - 1;
		}

		if (pos >= end) { // [end ... front .. pos]
			return (front - pos) + (count - 1);
		} else { // [pos ... end ... front ]
			return end - pos;
		}
	}
